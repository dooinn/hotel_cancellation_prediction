...
def app():
    ...
    # Filter the data for the selected date and not canceled
    filtered_data = data_on_date[data_on_date['is_canceled'] == 0]

    # Guest information for booking list
    guest_info = filtered_data[['country', 'adults', 'children', 'babies', 
                                'reserved_room_type', 'adr', 'reservation_status']]

    # Display the booking list in Streamlit app
